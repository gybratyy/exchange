...
my_books_action_markup = ReplyKeyboardMarkup(MY_BOOKS_ACTION_KEYBOARD_LAYOUT, one_time_keyboard=True,
...
profile_action_markup = ReplyKeyboardMarkup(PROFILE_ACTION_KEYBOARD_LAYOUT, one_time_keyboard=True,
                                            resize_keyboard=True)
