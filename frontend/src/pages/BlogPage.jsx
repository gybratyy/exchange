import {CalendarDays, Loader, Share2, Tag, ThumbsDown, ThumbsUp, Flag} from 'lucide-react';
                            ...
                            <div
                                ...
                                <div className="flex items-center space-x-4 sm:space-x-6">
                                    ...
                                    <button
                                        ...
                                        className='action-button flex items-center hover:text-red-500 transition-colors duration-200'
                                        aria-label="Dislike this post"
                                    >
                                        <Flag size={20} className="mr-1.5"/>
                                        <span className="text-sm font-medium">Report this item</span>
                                    </button>
