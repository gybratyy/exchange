            ...
            <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                ...
                >
                  ...
                  />
                    ...
                    <div className="hidden sm:block border-gray-300">
                        <label htmlFor="SortBy" className="sr-only border-gray-300">SortBy</label>

                        <select id="SortBy" className="h-10 rounded-sm border-gray-300 text-sm bg-transparent">
